...
class MockTvShowRepository extends _i1.Mock implements _i15.TvShowRepository {
  ...
  @override
  _i7.Future<_i2.Either<_i8.Failure, List<_i16.TvShow>>> getNowAiringTvShows(
          [int? page = 1]) =>
      (super.noSuchMethod(
        Invocation.method(
          #getNowAiringTvShows,
...
class MockTvShowRemoteDataSource extends _i1.Mock
  ...
  @override
  _i7.Future<List<_i19.TvShowModel>> getNowAiringTvShows([int? page = 1]) =>
      (super.noSuchMethod(
        Invocation.method(
          #getNowAiringTvShows,
          [page],
        ...
        returnValue:
            _i7.Future<List<_i19.TvShowModel>>.value(<_i19.TvShowModel>[]),
      ) as _i7.Future<List<_i19.TvShowModel>>);
  @override
  _i7.Future<List<_i19.TvShowModel>> getPopularTvShows([int? page = 1]) =>
      (super.noSuchMethod(
        Invocation.method(
          #getPopularTvShows,
          [page],
  ...
  @override
  _i7.Future<List<_i19.TvShowModel>> getTopRatedTvShows([int? page = 1]) =>
      (super.noSuchMethod(
        Invocation.method(
          #getTopRatedTvShows,
          [page],
  ...
  @override
  _i7.Future<List<_i19.TvShowModel>> getTvShowRecommendations(
    int? id, [
    int? page = 1,
  ]) =>
      (super.noSuchMethod(
  ...
  @override
  _i7.Future<List<_i19.TvShowModel>> searchTvShows(
    String? query, [
    int? page = 1,
  ]) =>
      (super.noSuchMethod(
...
class MockTvShowLocalDataSource extends _i1.Mock
    implements _i20.TvShowLocalDataSource {
  MockTvShowLocalDataSource() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i7.Future<String> insertWatchlist(_i21.TvShowTable? tvShow) =>
      (super.noSuchMethod(
        Invocation.method(
          #insertWatchlist,
          [tvShow],
  ...
  @override
  _i7.Future<String> removeWatchlist(_i21.TvShowTable? tvShow) =>
      (super.noSuchMethod(
        Invocation.method(
          #removeWatchlist,
          [tvShow],
  ...
  @override
  _i7.Future<_i21.TvShowTable?> getTvShowById(int? id) => (super.noSuchMethod(
        Invocation.method(
          #getTvShowById,
          [id],
        ),
  ...
  @override
  _i7.Future<List<_i21.TvShowTable>> getWatchlistTvShows() =>
      (super.noSuchMethod(
        Invocation.method(
          #getWatchlistTvShows,
          [],
...
class MockDatabaseHelper extends _i1.Mock implements _i22.DatabaseHelper {
  ...
  @override
  _i7.Future<int> insertWatchlist(_i24.WatchlistTable? watchlist) =>
      (super.noSuchMethod(
        Invocation.method(
          #insertWatchlist,
          [watchlist],
  ...
  @override
  _i7.Future<int> removeWatchlist(_i24.WatchlistTable? watchlist) =>
      (super.noSuchMethod(
        Invocation.method(
          #removeWatchlist,
          [watchlist],
  ...
  @override
  _i7.Future<List<Map<String, dynamic>>> getWatchlist(String? type) =>
      (super.noSuchMethod(
        Invocation.method(
          #getWatchlist,
          [type],
