...
// in ditonton/test/presentation/providers/movie/now_playing_movies_notifier_test.dart.
...
import '../../../../modules/movie/lib/domain/entities/movie.dart' as _i7;
...
class MockTarget extends _i1.Mock implements _i4.GetNowPlayingMovies {
  MockTarget() {
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, List<_i7.Movie>>> call([int? page = 1]) =>
      (super.noSuchMethod(
        Invocation.method(
          #call,
          [page],
