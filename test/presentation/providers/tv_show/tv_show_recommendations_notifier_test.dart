...
import 'tv_show_recommendations_notifier_test.mocks.dart';

typedef Notifier = TvShowRecommendationsNotifier;

@GenerateMocks([],
    customMocks: [MockSpec<GetTvShowRecommendations>(as: #MockTarget)])
void main() {
