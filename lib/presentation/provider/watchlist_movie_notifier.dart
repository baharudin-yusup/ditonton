...
import 'package:movie/domain/usecases/get_movie_watchlist.dart';

class WatchlistNotifier extends ChangeNotifier {
  var _moviesWatchlist = <Movie>[];
  var _tvShowsWatchlist = <TvShow>[];

  List<Watchlist> get moviesWatchlist => _moviesWatchlist;

  List<Watchlist> get tvShowsWatchlist => _tvShowsWatchlist;
