...
class TopRatedTvShowsNotifier extends EntertainmentListNotifier {
  TopRatedTvShowsNotifier(this._getTopRatedTvShows);
  ...
  Future<void> fetch() async {
    ...
    final result = await _getTopRatedTvShows(_page);
    result.fold(
      (failure) {
