...
typedef BlocType1 = MovieDetailBloc;
typedef BlocType2 = MovieRecommendationsBloc;
typedef BlocType3 = MovieWatchlistStatusBloc;
typedef BlocType4 = MovieWatchlistBloc;
typedef BlocState1 = MovieDetailState;
typedef BlocState2 = MovieRecommendationsState;
typedef BlocState3 = MovieWatchlistStatusState;
typedef BlocState4 = MovieWatchlistState;

typedef XPage = MovieDetailPage;
...
void main() {
  ...
  setUp(() {
    ...
    page = MultiBlocProvider(
      providers: [
        BlocProvider<MovieDetailBloc>(create: (_) => mockBlocType1),
        BlocProvider<MovieRecommendationsBloc>(create: (_) => mockBlocType2),
        BlocProvider<MovieWatchlistStatusBloc>(create: (_) => mockBlocType3),
        BlocProvider<MovieWatchlistBloc>(create: (_) => mockBlocType4),
      ],
    ...
    testWidgets(
      ...
      switch (i) {
        ...
        case 2:
          totalListCardWidget++;
          when(mockBlocType1.state)
              .thenReturn(const BlocState1.fetchDataSuccess(testMovieDetail));
          break;
        case 3:
          totalFailureWidget++;
          when(mockBlocType1.state)
