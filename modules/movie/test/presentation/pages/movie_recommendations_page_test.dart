...
import 'movie_recommendations_page_test.mocks.dart';

typedef BlocType1 = MovieRecommendationsBloc;
typedef BlocState1 = MovieRecommendationsState;

typedef XPage = MovieRecommendationsPage;
...
void main() {
  ...
  setUp(() {
    ...
    page = MultiBlocProvider(
      providers: [
        BlocProvider<MovieRecommendationsBloc>(create: (_) => mockBlocType1),
      ],
