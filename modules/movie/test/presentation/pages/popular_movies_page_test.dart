...
typedef BlocType1 = PopularMoviesBloc;
typedef BlocState1 = PopularMoviesState;

typedef XPage = PopularMoviesPage;
...
void main() {
  ...
  setUp(() {
    ...
    page = MultiBlocProvider(
      providers: [
        BlocProvider<PopularMoviesBloc>(create: (_) => mockBlocType1),
      ],
