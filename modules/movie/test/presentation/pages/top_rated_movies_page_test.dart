...
typedef BlocType1 = TopRatedMoviesBloc;
typedef BlocState1 = TopRatedMoviesState;

typedef XPage = TopRatedMoviesPage;
...
void main() {
  ...
  setUp(() {
    ...
    page = MultiBlocProvider(
      providers: [
        BlocProvider<TopRatedMoviesBloc>(create: (_) => mockBlocType1),
      ],
