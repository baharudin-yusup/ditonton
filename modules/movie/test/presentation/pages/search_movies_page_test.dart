...
typedef BlocType1 = SearchMoviesBloc;
typedef BlocState1 = SearchMoviesState;

typedef XPage = SearchMoviesPage;
...
void main() {
  ...
  setUp(() {
    ...
    page = MultiBlocProvider(
      providers: [
        BlocProvider<SearchMoviesBloc>(create: (_) => mockBlocType1),
      ],
      child: MaterialApp(
        home: XPage(),
      ),
      ...
      switch (i) {
        ...
        case 1:
          ...
          when(mockBlocType1.state)
              .thenReturn(const BlocState1.searchDataInProgress());
          break;
        case 2:
          totalListCardWidget++;
          when(mockBlocType1.state)
              .thenReturn(const BlocState1.searchDataSuccess(testWatchlist));
          break;
        case 3:
          totalFailureWidget++;
          when(mockBlocType1.state)
              .thenReturn(const BlocState1.searchDataFailure(errorMessage));
          break;
      }
