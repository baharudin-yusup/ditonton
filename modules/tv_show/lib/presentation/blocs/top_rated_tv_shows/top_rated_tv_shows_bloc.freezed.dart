...
mixin _$TopRatedTvShowsEvent {
  ...
  @JsonKey(ignore: true)
  $TopRatedTvShowsEventCopyWith<TopRatedTvShowsEvent> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $TopRatedTvShowsEventCopyWith<$Res> {
  factory $TopRatedTvShowsEventCopyWith(TopRatedTvShowsEvent value,
          $Res Function(TopRatedTvShowsEvent) then) =
      _$TopRatedTvShowsEventCopyWithImpl<$Res, TopRatedTvShowsEvent>;
  @useResult
  $Res call({int page});
}

/// @nodoc
class _$TopRatedTvShowsEventCopyWithImpl<$Res,
        $Val extends TopRatedTvShowsEvent>
    implements $TopRatedTvShowsEventCopyWith<$Res> {
  _$TopRatedTvShowsEventCopyWithImpl(this._value, this._then);
...
class __$$_FetchDataStartedCopyWithImpl<$Res>
    extends _$TopRatedTvShowsEventCopyWithImpl<$Res, _$_FetchDataStarted>
...
class _$_FetchDataStarted implements _FetchDataStarted {
  ...
  @override
  String toString() {
    return 'TopRatedTvShowsEvent.fetchDataStarted(page: $page)';
  }
...
abstract class _FetchDataStarted implements TopRatedTvShowsEvent {
...
mixin _$TopRatedTvShowsState {
  ...
  @JsonKey(ignore: true)
  $TopRatedTvShowsStateCopyWith<TopRatedTvShowsState> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $TopRatedTvShowsStateCopyWith<$Res> {
  factory $TopRatedTvShowsStateCopyWith(TopRatedTvShowsState value,
          $Res Function(TopRatedTvShowsState) then) =
      _$TopRatedTvShowsStateCopyWithImpl<$Res, TopRatedTvShowsState>;
  @useResult
  $Res call({int page});
}

/// @nodoc
class _$TopRatedTvShowsStateCopyWithImpl<$Res,
        $Val extends TopRatedTvShowsState>
    implements $TopRatedTvShowsStateCopyWith<$Res> {
  _$TopRatedTvShowsStateCopyWithImpl(this._value, this._then);
...
class __$$_InitialCopyWithImpl<$Res>
    extends _$TopRatedTvShowsStateCopyWithImpl<$Res, _$_Initial>
...
class _$_Initial implements _Initial {
  ...
  @override
  String toString() {
    return 'TopRatedTvShowsState.initial(page: $page)';
  }
...
abstract class _Initial implements TopRatedTvShowsState {
...
class __$$_FetchDataInProgressCopyWithImpl<$Res>
    extends _$TopRatedTvShowsStateCopyWithImpl<$Res, _$_FetchDataInProgress>
...
class _$_FetchDataInProgress implements _FetchDataInProgress {
  ...
  @override
  String toString() {
    return 'TopRatedTvShowsState.fetchDataInProgress(page: $page)';
  }
...
abstract class _FetchDataInProgress implements TopRatedTvShowsState {
...
class __$$_FetchDataSuccessCopyWithImpl<$Res>
    extends _$TopRatedTvShowsStateCopyWithImpl<$Res, _$_FetchDataSuccess>
...
class _$_FetchDataSuccess implements _FetchDataSuccess {
  ...
  @override
  String toString() {
    return 'TopRatedTvShowsState.fetchDataSuccess(movies: $movies, page: $page)';
  }
...
abstract class _FetchDataSuccess implements TopRatedTvShowsState {
...
class __$$_FetchDataFailureCopyWithImpl<$Res>
    extends _$TopRatedTvShowsStateCopyWithImpl<$Res, _$_FetchDataFailure>
...
class _$_FetchDataFailure implements _FetchDataFailure {
  ...
  @override
  String toString() {
    return 'TopRatedTvShowsState.fetchDataFailure(message: $message, page: $page)';
  }
...
abstract class _FetchDataFailure implements TopRatedTvShowsState {
