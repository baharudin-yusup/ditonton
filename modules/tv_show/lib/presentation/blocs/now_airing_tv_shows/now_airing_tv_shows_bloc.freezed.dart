...
mixin _$NowAiringTvShowsEvent {
  ...
  @JsonKey(ignore: true)
  $NowAiringTvShowsEventCopyWith<NowAiringTvShowsEvent> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $NowAiringTvShowsEventCopyWith<$Res> {
  factory $NowAiringTvShowsEventCopyWith(NowAiringTvShowsEvent value,
          $Res Function(NowAiringTvShowsEvent) then) =
      _$NowAiringTvShowsEventCopyWithImpl<$Res, NowAiringTvShowsEvent>;
  @useResult
  $Res call({int page});
}

/// @nodoc
class _$NowAiringTvShowsEventCopyWithImpl<$Res,
        $Val extends NowAiringTvShowsEvent>
    implements $NowAiringTvShowsEventCopyWith<$Res> {
  _$NowAiringTvShowsEventCopyWithImpl(this._value, this._then);
...
class __$$_FetchDataStartedCopyWithImpl<$Res>
    extends _$NowAiringTvShowsEventCopyWithImpl<$Res, _$_FetchDataStarted>
...
class _$_FetchDataStarted implements _FetchDataStarted {
  ...
  @override
  String toString() {
    return 'NowAiringTvShowsEvent.fetchDataStarted(page: $page)';
  }
...
abstract class _FetchDataStarted implements NowAiringTvShowsEvent {
...
mixin _$NowAiringTvShowsState {
  ...
  @JsonKey(ignore: true)
  $NowAiringTvShowsStateCopyWith<NowAiringTvShowsState> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $NowAiringTvShowsStateCopyWith<$Res> {
  factory $NowAiringTvShowsStateCopyWith(NowAiringTvShowsState value,
          $Res Function(NowAiringTvShowsState) then) =
      _$NowAiringTvShowsStateCopyWithImpl<$Res, NowAiringTvShowsState>;
  @useResult
  $Res call({int page});
}

/// @nodoc
class _$NowAiringTvShowsStateCopyWithImpl<$Res,
        $Val extends NowAiringTvShowsState>
    implements $NowAiringTvShowsStateCopyWith<$Res> {
  _$NowAiringTvShowsStateCopyWithImpl(this._value, this._then);
...
class __$$_InitialCopyWithImpl<$Res>
    extends _$NowAiringTvShowsStateCopyWithImpl<$Res, _$_Initial>
...
class _$_Initial implements _Initial {
  ...
  @override
  String toString() {
    return 'NowAiringTvShowsState.initial(page: $page)';
  }
...
abstract class _Initial implements NowAiringTvShowsState {
...
class __$$_FetchDataInProgressCopyWithImpl<$Res>
    extends _$NowAiringTvShowsStateCopyWithImpl<$Res, _$_FetchDataInProgress>
...
class _$_FetchDataInProgress implements _FetchDataInProgress {
  ...
  @override
  String toString() {
    return 'NowAiringTvShowsState.fetchDataInProgress(page: $page)';
  }
...
abstract class _FetchDataInProgress implements NowAiringTvShowsState {
...
class __$$_FetchDataSuccessCopyWithImpl<$Res>
    extends _$NowAiringTvShowsStateCopyWithImpl<$Res, _$_FetchDataSuccess>
...
class _$_FetchDataSuccess implements _FetchDataSuccess {
  ...
  @override
  String toString() {
    return 'NowAiringTvShowsState.fetchDataSuccess(movies: $movies, page: $page)';
  }
...
abstract class _FetchDataSuccess implements NowAiringTvShowsState {
...
class __$$_FetchDataFailureCopyWithImpl<$Res>
    extends _$NowAiringTvShowsStateCopyWithImpl<$Res, _$_FetchDataFailure>
...
class _$_FetchDataFailure implements _FetchDataFailure {
  ...
  @override
  String toString() {
    return 'NowAiringTvShowsState.fetchDataFailure(message: $message, page: $page)';
  }
...
abstract class _FetchDataFailure implements NowAiringTvShowsState {
