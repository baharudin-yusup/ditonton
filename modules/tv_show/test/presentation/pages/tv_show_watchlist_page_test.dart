...
import 'tv_show_watchlist_page_test.mocks.dart';

typedef BlocType1 = TvShowWatchlistBloc;
typedef BlocState1 = TvShowWatchlistState;

typedef XPage = TvShowWatchlistPage;
...
void main() {
  ...
  setUp(() {
    ...
    page = MultiBlocProvider(
      providers: [
        BlocProvider<TvShowWatchlistBloc>(create: (_) => mockBlocType1),
      ],
