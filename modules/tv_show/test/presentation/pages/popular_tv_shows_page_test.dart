...
typedef BlocType1 = PopularTvShowsBloc;
typedef BlocState1 = PopularTvShowsState;

typedef XPage = PopularTvShowsPage;
...
void main() {
  ...
  setUp(() {
    ...
    page = MultiBlocProvider(
      providers: [
        BlocProvider<PopularTvShowsBloc>(create: (_) => mockBlocType1),
      ],
