...
typedef BlocType1 = SearchTvShowsBloc;
typedef BlocState1 = SearchTvShowsState;

typedef XPage = SearchTvShowsPage;
...
void main() {
  ...
  setUp(() {
    ...
    page = MultiBlocProvider(
      providers: [
        BlocProvider<SearchTvShowsBloc>(create: (_) => mockBlocType1),
      ],
      child: MaterialApp(
        home: XPage(),
      ),
    ...
    testWidgets('handle bloc1 case = $i', (tester) async {
      ...
      switch (i) {
        ...
        case 2:
          totalListCardWidget++;
          when(mockBlocType1.state)
              .thenReturn(BlocState1.searchDataSuccess(testWatchlist));
          break;
        case 3:
          totalFailureWidget++;
          when(mockBlocType1.state)
