...
import 'tv_show_recommendations_page_test.mocks.dart';

typedef BlocType1 = TvShowRecommendationsBloc;
typedef BlocState1 = TvShowRecommendationsState;

typedef XPage = TvShowRecommendationsPage;
...
void main() {
  ...
  setUp(() {
    ...
    page = MultiBlocProvider(
      providers: [
        BlocProvider<TvShowRecommendationsBloc>(create: (_) => mockBlocType1),
      ],
