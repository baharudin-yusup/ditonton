...
import 'tv_show_dashboard_page_test.mocks.dart';

typedef BlocType1 = NowAiringTvShowsBloc;
typedef BlocType2 = PopularTvShowsBloc;
typedef BlocType3 = TopRatedTvShowsBloc;
typedef BlocState1 = NowAiringTvShowsState;
typedef BlocState2 = PopularTvShowsState;
typedef BlocState3 = TopRatedTvShowsState;

typedef XPage = TvShowDashboardPage;
...
void main() {
  ...
  setUp(() {
    ...
    page = MultiBlocProvider(
      providers: [
        BlocProvider<NowAiringTvShowsBloc>(create: (_) => mockBlocType1),
        BlocProvider<PopularTvShowsBloc>(create: (_) => mockBlocType2),
        BlocProvider<TopRatedTvShowsBloc>(create: (_) => mockBlocType3),
      ],
